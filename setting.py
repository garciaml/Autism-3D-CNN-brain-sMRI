...
# --data_root '' --img_list '' --n_seg_classes 2 --learning_rate 0.001 --num_workers 4 --batch_size 1 --phase train --save_intervals 10 --n_epochs 200 --input_D 256 --input_H 256 --input_W 256 --resume_path "./trained_models" --pretrain_path pretrain/resnet_50.pth --new_layer_names ['conv_seg'] --no_cuda False --gpu_id 0,1,2,3 --model 'resnet' --model_depth 50 --resnet_shortcut B --manual_seed 1 --ci_test False
